...
import Add__Sub_Category_Hook from '../../CustomHooks/SubCategory/Add_Sub_Category_Hook';
const AdminAddSubCategory = () => {
  const [id, name, loading, category, subcategory, handelChange, handelSubmit, onChangeName] = Add__Sub_Category_Hook();
